        ...
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <div className="modal-body">
                    <p>
                        Las cookies son pequeños fragmentos de texto enviados por su navegador web por un sitio web que visitas. Un archivo cookie se almacena en su navegador web y permite que el Servicio o un tercero lo reconozca y haga que su próxima visita sea más fácil y que el Servicio le resulte más útil.
                    </p>
                    ...
                    <p>
                        Para obtener más información sobre cómo manejamos tus datos personales y cookies, consulta nuestra política de privacidad.
                    </p>
                </div>
