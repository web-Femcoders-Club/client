        ...
        <div key={member.idMember} className="card-team-member">
          <div className="card-team-member-content">
            ...
            <div className="card-team-member-details">
              ...
              <p className="card-team-member-linkedin" title={member.memberLinkedin}>
                <FaLinkedin className="icon" />
                <a href={member.memberLinkedin} target="_blank" rel="noopener noreferrer" className="linkedin-url">
