    ...
    <>
      ...
      <section className="blog-content">
        <div ref={recursosRef} className="categories-section">
          <h3>Temas Populares</h3>
          <div className="category-buttons">
            <button onClick={() => handleCategoryFilter("html")} className="button secondary-button">HTML</button>
            <button onClick={() => handleCategoryFilter("javascript")} className="button secondary-button">JavaScript</button>
            <button onClick={() => handleCategoryFilter("react")} className="button secondary-button">React</button>
            <button onClick={() => handleCategoryFilter("css")} className="button secondary-button">CSS</button>
            <button onClick={() => handleCategoryFilter("python")} className="button secondary-button">Python</button>
            <button onClick={() => handleCategoryFilter("femCoders")} className="button secondary-button">femCoders Club</button>
          </div>
        </div>
                ...
                filteredPosts.map((post) => (
                  <div key={post.id} className="post-card">
                    ...
                    <Link
                      ...
                      className={`button ${post.type === "noticia" ? "primary-button" : "secondary-button"}`}
                    >
                      {post.type === "noticia" ? "Leer más" : "Ver recurso"}
                    </Link>
                  </div>
