    ...
    <div className="recursos">
      ...
      <div className="recurso-item bg1">
        <div className="noticia-content">
          ...
          <Link to="/recursos/html/introduccion-html" className="secondary-button" aria-label="Leer más sobre Introducción a HTML">
            Leer más
          </Link>
        </div>
      </div>
      ...
      <div className="recurso-item bg1">
        <div className="noticia-content">
          <div>
            <h3>Elementos HTML Clave: Encabezados, Párrafos, Enlaces e Imágenes</h3>
            <p className="intro-text">
              Descubre los elementos más utilizados en HTML, la importancia del atributo alt y el uso de videos y emojis.
            </p>
          </div>
          <Link to="/recursos/html/elementos-html-clave" className="secondary-button" aria-label="Leer más sobre Elementos HTML Clave">
            Leer más
          </Link>
        </div>
      </div>
      ...
      <div className="recurso-item bg1">
        <div className="noticia-content">
          ...
          <Link to="/recursos/css/introduccion-css" className="secondary-button" aria-label="Leer más sobre ¿Qué es CSS y por qué es esencial para el diseño web?">
            Leer más
          </Link>
        </div>
      </div>
      ...
      <div className="recurso-item bg1">
        <div className="noticia-content">
          ...
          <Link to="/recursos/html/html-semantico" className="secondary-button" aria-label="Leer más sobre HTML Semántico y Diseño de Layout">
            Leer más
          </Link>
        </div>
      </div>
      ...
      <div className="recurso-item bg1">
        <div className="noticia-content">
          <div>
            ...
            <p className="intro-text">
              Aprende a estructurar formularios y tablas en HTML. Descubre etiquetas importantes y casos de uso comunes.
            </p>
          </div>
          <Link to="/recursos/html/formularios-y-tablas" className="secondary-button" aria-label="Leer más sobre Formularios y Tablas en HTML">
            Leer más
          </Link>
        </div>
      </div>
