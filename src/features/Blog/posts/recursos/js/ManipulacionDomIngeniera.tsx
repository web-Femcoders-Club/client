...
import { FaBell, FaBook, FaBolt, FaBullseye, FaCheck, FaCode, FaCogs, FaEye, FaGithub, FaGraduationCap, FaLightbulb, FaMousePointer, FaRocket, FaTools } from "react-icons/fa";
...
const ManipulacionDomIngeniera: React.FC = () => {
  ...
  return (
    <article className="blog-post">
      ...
      <ShareButtons path="/recursos/js/manipulacion-dom-ingeniera" title="Manipulaci&oacute;n del DOM como una Ingeniera" />
