...
import { BsSpotify, BsInstagram, BsLinkedin, BsYoutube, BsGithub } from 'react-icons/bs';
    ...
    <div className="contact-page">
      ...
      <main className="contact-main">
        <section className="contact-info">
          ...
          <p>¿Tienes alguna pregunta o comentario? <br />¡Nos encantaría saber de ti! No dudes en ponerte en contacto <br />con nosotras a través de cualquiera de los siguientes medios:</p>
          <ul>
            <li>
             <span> Email: <a href={`mailto:${recipientEmail}`} aria-label="Email">{recipientEmail}</a></span>
            </li>
          ...
          <div className="social-links">
            ...
            <a href="https://github.com/femcodersclub" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
