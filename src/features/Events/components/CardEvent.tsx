...
const CardEvent: React.FC<CardEventProps> = ({
  ...
  // Manejar navegación por teclado en la parte frontal
  ...
  // Manejar hover en la parte frontal
  const handleMouseEnter = () => {
    setIsFlipped(true);
  };

  // Para volver desde el botón trasero
  ...
  return (
    ...
    >
      ...
      >
        {/* Parte frontal - se gira con hover o teclado */}
        <div
        ...
        {/* Parte trasera - solo se vuelve al hacer clic en el botón de volver */}
