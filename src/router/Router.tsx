    ...
    <>
      <Suspense fallback={<Loader />}>
        <Routes>
          ...
          <Route path="/noticias/Aniversario" element={<Layout><Aniversario /></Layout>} />
          <Route path="/recursos/html/introduccion-html" element={<Layout><IntroduccionHTML /></Layout>} />
          ...
          <Route path="/recursos/html/elementos-html-clave" element={<Layout><ElementosHTMLClave /></Layout>} />
          <Route path="/recursos/html/html-semantico" element={<Layout><HtmlSemantico /></Layout>} />
